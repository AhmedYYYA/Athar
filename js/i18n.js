...
ATHAR.i18n=(function(){
  var KEY='athar-lang',LEGACY='athar.lang';var strings={
  ...
  function lang(){return (localStorage.getItem(KEY)||localStorage.getItem(LEGACY))==='ar'?'ar':'en'}
  ...
  function set(l){l=l==='ar'?'ar':'en';localStorage.setItem(KEY,l);localStorage.setItem(LEGACY,l);apply();document.dispatchEvent(new CustomEvent('athar:language'))}
