...
['what-is-ai','patterns','data','clear-asking','details','refine','can-be-wrong','verify','fairness','private','not-human','my-idea','credit','steps','rules','loops'].forEach(id=>['en','ar'].forEach(lang=>walkthrough(id,lang)));
