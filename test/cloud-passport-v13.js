...
for(const forbidden of ['raw_answer','child_answer','prompt_text','transcript','conversation_text','child_email','child_phone','date_of_birth'])ok(!schema.toLowerCase().includes(forbidden),`Forbidden cloud field/token: ${forbidden}`);
